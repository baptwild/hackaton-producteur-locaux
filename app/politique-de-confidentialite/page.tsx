...
export default function PrivacyPolicy() {
  return (
    <div className='container section-padding'>
      <Breadcrumb steps={[{ label: 'Politique de Confidentialité' }]} />
      <div className='prose-container'>
        ...
        <p className='text-large mb-2'>
          ...
          <strong>Les Voisins de Panier</strong> recueille, utilise et protège
          les informations de ses utilisateurs (ci-après "l'Utilisateur") dans
          le cadre de sa mission de promotion des circuits courts à Grenoble.
        </p>
        ...
        <section className='mb-2'>
          ...
          >
            <li>
              Données de navigation (via Piwik PRO) : Adresse IP anonymisée,
              type de terminal, pages consultées.
            </li>
            <li>
        ...
        <section className='mb-2'>
          ...
          <p className='mb-1'>
            ...
            mesurer l'audience et le comportement des utilisateurs. Cette
            analyse nous permet :
          </p>
          <ul
            className='text-muted'
          ...
          >
            ...
            <li>
              De valider l'intérêt pour certaines filières (Maraîchers,
              Fromagers, etc.) sur la métropole grenobloise.
            </li>
          </ul>
        </section>
        ...
        <section className='mb-2'>
          ...
          <div className='local-seo-box mb-1'>
            ...
            <em>robots.txt</em> des sources cibles et limitons la fréquence de
            nos requêtes (Rate Limiting).
          </div>
        </section>
        ...
        <section className='mb-2'>
          ...
          <p>
            ...
            traitement des données des producteurs (issus du scraping) repose
            sur l'<strong>intérêt légitime</strong> de notre plateforme à
            proposer un service d'information d'intérêt public sur les filières
            durables en Isère.
          </p>
        </section>
        ...
        <section className='mb-2'>
          ...
          <p>
            Nous ne vendons, n'échangeons ni ne louons aucune donnée personnelle
            à des tiers. Les données agrégées et anonymisées peuvent être
            partagées avec nos partenaires locaux (institutionnels ou
            coopératives) à des fins d'analyse du développement économique
            local.
          </p>
        </section>
