...
const MentionsLegales: React.FC = () => {
  return (
    <div className='container section-padding' style={{ maxWidth: '800px' }}>
      ...
      <p>
        En conformité avec la loi Informatique et Libertés n° 78-17 du 6 janvier
        1978, les utilisateurs disposent d'un droit d'accès, de modification, de
        rectification et de suppression des données qui les concernent. Pour
        exercer ce droit, veuillez nous contacter à l'adresse suivante : [Votre
        Email].
      </p>
